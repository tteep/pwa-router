...
const DEMO_RULES: RoutingRule[] = [
  {
    ...
    dest_package: 'com.microsoft.outlook',
    dest_display_name: 'Outlook',
    priority: 90,
    is_enabled: true,
  },
  {
    ...
    dest_package: 'com.google.android.gm',
    dest_display_name: 'Gmail',
    priority: 10,
    is_enabled: true,
  },
  {
    ...
    condition_operator: null,
    condition_value: null,
    dest_package: 'com.google.android.apps.maps',
    dest_display_name: 'Google Maps',
    priority: 50,
    is_enabled: true,
  },
  {
    ...
    condition_operator: null,
    condition_value: null,
    dest_package: 'com.adobe.reader',
    dest_display_name: 'Adobe Reader',
    priority: 50,
    is_enabled: false,
  },
];
